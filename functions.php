 ...
 */
    function bootstrap_filmes() {
        $labels = array(
            ...
            'not_found' => "Nenhum filme Encontrato",
        ...
        $args = array(
            ...
            'query_var' => true,
            'rewrite' => true,              //link personalizado / acessar o post por um link otimizado.
            'capability_type' => "post",    // herdar paginas/categorias / post por padrão
            'supports' => array(
                'title',    //padrãp
                'editor',   //padrão
                'thumbnail',
                'excerpt',  //resumos de post
            ),
            'menu_position' => 5, //Padrão 5 / posição aonde o item vai ficar no menu do wordpress
            'exlude_from_search' => false //Se quer exluir os itens do post
        );

        register_post_type('filmes', $args); //Nome do post, comportamentos do posttype
    }

    add_action('init', 'bootstrap_filmes');
    ...
    function bootstrap_son_taxonomias() {
        ...
        $labels = array (
            'name'=> "Gêneros",
            'singular_name'=> "Procurar Gêneros",
            'search_items'=> "Todos os Gêneros",
            'all_items'=> "Todos os Gêneros",
            'parent_item'=> "Gêneros Pai",
            'parent_item_colon'=> "Gêneros Pai",
            'edit_item'=> "Editar Gêneros",
            'update_item'=> "Atualizar Gêneros",
        ...
        register_taxonomy('genero', 'filmes', $argss );
        ...
        register_taxonomy( 'diretores', 'filmes', $argss );
    }
